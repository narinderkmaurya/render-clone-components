...
const NewFrameC: NextPage = () => {
  ...
  return (
    <section className="self-stretch flex flex-col items-start justify-start max-w-full text-left text-xl ">
      <motion.div ref={ref} initial="hidden" animate={controls} variants={slideUpVariant} className="self-stretch flex flex-row items-end justify-between py-0 pr-[3px] pl-0 box-border gap-[20px] max-w-full mq950:flex-wrap">
        <motion.div variants={slideUpVariant} className=" h-[100px] w-[100px] relative box-border z-[1] border-t-[1px] border-solid border-lightgray-200 border-r-[1px]" />
        <div className=" box-border flex flex-row items-center justify-end py-[53px] pr-[34px] pl-[47px] max-w-full z-[1] border-t-[1px] border-solid border-lightgray-200 border-l-[1px] mq700:pl-[23px] mq700:box-border">
          <motion.div variants={slideUpVariant} className="h-[250px] w-[650px] relative  box-border hidden max-w-full border-t-[1px] border-solid border-lightgray-200 border-l-[1px]" />
          <motion.div variants={slideUpVariant} className={`w-[609px] relative  font-medium inline-block min-h-[144px] max-w-full z-[2] mq450:text-base text-[1.25rem] leading-[2rem] ${regular.className}`} style={{ fontWeight: "500" }}>
      ...
      <motion.footer variants={slideUpVariant} className="self-stretch h-[50px] relative  box-border z-[1] border-t-[1px] border-solid border-lightgray-200 border-b-[1px]">
